...
{
	/// <summary>
	/// The exception that is thrown when a white-characters only reference is passed to a method that does not accept it as a valid argument. 
	/// </summary>
	[Serializable]
	public class ArgumentWhiteSpaceException : ArgumentException
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ArgumentWhiteSpaceException"/> class with the name of the parameter that causes this exception.
		/// </summary>

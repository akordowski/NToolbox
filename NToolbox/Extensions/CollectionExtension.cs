...
namespace NToolbox.Extensions
{
	...
	public static class CollectionExtension
	{
		...
		/// <param name="separator">The string to use as a separator. <em>separator</em> is included in the returned string only if <em>col</em> has more than one element.</param>
		/// <returns>A string that consists of the members of <em>col</em> delimited by the <em>separator</em> string. If <em>col</em> has no members, the method returns <see cref="String.Empty"/>.</returns>

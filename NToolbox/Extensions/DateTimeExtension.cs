...
namespace NToolbox.Extensions
{
	...
	public static class DateTimeExtension
	{
		...
		/// <summary>
		/// Returns a new <see cref="DateTime"/> that represents the first day of month of this instance.
		/// </summary>
		/// <param name="date">A date and time.</param>
		/// <returns>An object whose value is the first day of month represented by this instance.</returns>
		...
		/// <summary>
		/// Returns a new <see cref="DateTime"/> that represents the first day of year of this instance.
		/// </summary>
		/// <param name="date">A date and time.</param>
		/// <returns>An object whose value is the first day of year represented by this instance.</returns>
		...
		/// </summary>
		/// <param name="date">A date and time.</param>
		/// <returns><strong>true</strong> if <em>year</em> of the instance is a leap year; otherwise, <strong>false</strong>.</returns>
		...
		/// <summary>
		/// Returns a new <see cref="DateTime"/> that represents the last day of month of this instance.
		/// </summary>
		/// <param name="date">A date and time.</param>
		/// <returns>An object whose value is the last day of month represented by this instance.</returns>
		...
		/// <summary>
		/// Returns a new <see cref="DateTime"/> that represents the last day of year of this instance.
		/// </summary>
		/// <param name="date">A date and time.</param>
		/// <returns>An object whose value is the last day of year represented by this instance.</returns>
		...
		/// <returns>A new object that has the same number of ticks as the object represented by the <em>date</em> parameter and the <see cref="DateTimeKind"/> value specified by the <em>kind</em> parameter.</returns>

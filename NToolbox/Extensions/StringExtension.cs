...
namespace NToolbox.Extensions
{
	...
	public static class StringExtension
	{
		...
		/// <exception cref="FormatException">The format of <em>str</em> is invalid. <em>str</em>
		/// contains a non-base-64 character.</exception>
		...
		/// digits. Default character encoding UTF-8.
		/// </summary>
		...
		/// </summary>
		/// <param name="str">A string to test.</param>
		/// <returns><strong>true</strong> if the <em>str</em> parameter is an lower case string;
		...
		/// </summary>
		/// <param name="str">A string to test.</param>
		/// <returns><strong>true</strong> if the <em>str</em> parameter is <strong>null</strong>
		/// or an empty string; otherwise, <strong>false</strong>.</returns>
		...
		/// <summary>
		/// Indicates whether the string is null, an empty string, or consists only of white-space
		/// characters.
		/// </summary>
		/// <param name="str">A string to test.</param>
		/// <returns><strong>true</strong> if the <em>str</em> parameter is <strong>null</strong>
		/// or an empty string, or if <em>str</em> consists only of white-space characters;
		/// otherwise, <strong>false</strong>.</returns>
		...
		/// <param name="separator">A character array that delimits the substrings in this string,
		/// an empty array that contains no delimiters, or <strong>null</strong>.</param>
		/// <returns>An array whose elements contain the substrings in this instance that are
		/// delimited by one or more characters in <em>separator</em>.</returns>
		/// <exception cref="ArgumentNullException"><em>str</em> is
		/// <strong>null</strong>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>An 8-bit unsigned integer that is equivalent to <em>str</em>, or zero if
		/// <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9).</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="Byte.MinValue"/> or greater than <see cref="Byte.MaxValue"/>.</exception>
		...
		/// <summary>
		/// Converts the string representation of a date and time to an equivalent date and time
		/// value.
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>The date and time equivalent of the value of <em>str</em>, or the date and
		/// time equivalent of <see cref="DateTime.MinValue"/> if <em>str</em> is
		/// <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> is not a properly formatted date and
		/// time string.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A decimal number that is equivalent to the number in <em>str</em>, or 0 (zero)
		/// if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> is not a number in a valid
		/// format.</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		...
		/// <summary>
		/// Converts the string representation of a number to an equivalent double-precision
		/// floating-point number.
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A double-precision floating-point number that is equivalent to the number in
		/// <em>str</em>, or 0 (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> is not a number in a valid
		/// format.</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 16-bit signed integer that is equivalent to the number in <em>str</em>, or 0
		/// (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9). </exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="Int16.MinValue"/> or greater than <see cref="Int16.MaxValue"/>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 32-bit signed integer that is equivalent to the number in <em>str</em>, or 0
		/// (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9). </exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="Int32.MinValue"/> or greater than <see cref="Int32.MaxValue"/>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 64-bit signed integer that is equivalent to the number in <em>str</em>, or 0
		/// (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9). </exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="Int64.MinValue"/> or greater than <see cref="Int64.MaxValue"/>.</exception>
		...
		/// <param name="separator">A character array that delimits the substrings in this string,
		/// an empty array that contains no delimiters, or <strong>null</strong>.</param>
		/// <returns>An list whose elements contain the substrings in this instance that are
		/// delimited by one or more characters in <em>separator</em>.</returns>
		/// <exception cref="ArgumentNullException"><em>str</em> is
		/// <strong>null</strong>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 8-bit signed integer that is equivalent to the number in <em>str</em>, or 0
		/// (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9).</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="SByte.MinValue"/> or greater than <see cref="SByte.MaxValue"/>.</exception>
		...
		/// format.</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="Single.MinValue"/> or greater than
		/// <see cref="Single.MaxValue"/>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 16-bit unsigned integer that is equivalent to the number in <em>str</em>, or
		/// 0 (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9).</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="UInt16.MinValue"/> or greater than
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 32-bit unsigned integer that is equivalent to the number in <em>str</em>, or
		/// 0 (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9).</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="UInt32.MinValue"/> or greater than
		/// <see cref="UInt32.MaxValue"/>.</exception>
		...
		/// </summary>
		/// <param name="str">A string to convert.</param>
		/// <returns>A 64-bit unsigned integer that is equivalent to the number in <em>str</em>, or
		/// 0 (zero) if <em>str</em> is <strong>null</strong>.</returns>
		/// <exception cref="FormatException"><em>str</em> does not consist of an optional sign
		/// followed by a sequence of digits (0 through 9).</exception>
		/// <exception cref="OverflowException"><em>str</em> represents a number that is less than
		/// <see cref="UInt64.MinValue"/> or greater than
		/// <see cref="UInt64.MaxValue"/>.</exception>
